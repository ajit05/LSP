...
import com.infosys.LSP.entity.Borrower;
import com.infosys.LSP.entity.ContactDetail;
...
import com.infosys.LSP.utility.DateConverter;
...
public class CreateLoanDAOImpl implements CreateLoanDAO {
	...
	public LoanDetail getCreateLoanApplicationDetails(String transactionId) {
		Session  currentSession=entitymanager.unwrap(Session.class);
		LoanDetail loanDetail= currentSession.get(LoanDetail.class, transactionId);
		return loanDetail;
